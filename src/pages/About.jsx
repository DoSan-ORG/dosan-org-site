        ...
        <section className="position-relative pt-5">
            ...
            <div className="container position-relative zindex-5 pt-5">
                ...
                <div className="col-lg-6">
                    ...
                    <img src={clutchDarkImage} className=" d-dark-mode-none" width="175" alt="Clutch" />
                    <img src={clutchLightImage} className="d-none d-dark-mode-block" width="175" alt="Clutch" />
